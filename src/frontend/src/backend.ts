...
export class Backend implements backendInterface {
    ...
    async getTransactionCount(): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.getTransactionCount();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async resetBalance(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.resetBalance();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async sendFlashTransaction(arg0: string, arg1: number, arg2: string): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.sendFlashTransaction(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
